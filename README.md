...
- Browser: `unlock-codes-editor.html` | CLI: `unlock-codes-editor.py` | Docs: [DOC_CODES.md](DOC_CODES.md)

**Text Editor** — Rename characters and objects across all 6 languages. Handles custom charset and checksums automatically.
- Browser: `text-editor.html` | CLI: `text-editor.py` | Docs: [DOC_NOMS.md](DOC_NOMS.md)

**Purge Save Backup** — Clear the backup save slot by filling it with 0xFF bytes.
- CLI: `purge_backup.py` | Docs: [DOC_PURGE_BACKUP.md](DOC_PURGE_BACKUP.md)
...
- Browser: `language-patcher.html` | Docs: [DOC_LANGUAGE_PATCHER.md](DOC_LANGUAGE_PATCHER.md)
...
- [DOC_CODES.md](DOC_CODES.md) — Unlock codes
- [DOC_NOMS.md](DOC_NOMS.md) — Renaming
- [DOC_PURGE_BACKUP.md](DOC_PURGE_BACKUP.md) — Backup cleanup
- [DOC_LANGUAGE_PATCHER.md](DOC_LANGUAGE_PATCHER.md) — Language switching
...
- Navigateur: `unlock-codes-editor.html` | CLI: `unlock-codes-editor.py` | Docs: [DOC_CODES.md](DOC_CODES.md)
...
- Navigateur: `text-editor.html` | CLI: `text-editor.py` | Docs: [DOC_NOMS.md](DOC_NOMS.md)
...
- Navigateur: `language-patcher.html` | Docs: [DOC_LANGUAGE_PATCHER.md](DOC_LANGUAGE_PATCHER.md)
...
- [DOC_CODES.md](DOC_CODES.md) — Codes de deverrouillage
- [DOC_NOMS.md](DOC_NOMS.md) — Renommage
- [DOC_PURGE_BACKUP.md](DOC_PURGE_BACKUP.md) — Nettoyage du backup
- [DOC_LANGUAGE_PATCHER.md](DOC_LANGUAGE_PATCHER.md) — Changement de langue
